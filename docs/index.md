...
hero:
  ...
  tagline: A fast local CLI for tracking tokens and estimated costs across Claude Code, NCode, ZCode, Codex, OpenCode, Amp, Droid, Codebuff, Hermes Agent, pi-agent, Goose, OpenClaw, Kilo, Kimi, Qwen, GitHub Copilot CLI, and Gemini CLI
  image:
    src: /logo.svg
    alt: ccusage logo
  actions:
...
features:
  ...
  - icon: 📁
    ...
    details: Reads local usage logs from Claude Code, NCode, ZCode, Codex, OpenCode, Amp, Droid, Codebuff, Hermes Agent, pi-agent, Goose, OpenClaw, Kilo, Kimi, Qwen, GitHub Copilot CLI, and Gemini CLI while keeping your data local
    link: /guide/
  - icon: 💰
    title: Cost Analysis
